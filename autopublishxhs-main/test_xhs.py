...
# from config import test_cookie
from utils import beauty_print
test_cookie = "a1=187d2defea8dz1fgwydnci40kw265ikh9fsxn66qs50000726043;webId=ba57f42593b9e55840a289fa0b755374;gid.sign=PSF1M3U6EBC/Jv6eGddPbmsWzLI=;gid=yYWfJfi820jSyYWfJfdidiKK0YfuyikEvfISMAM348TEJC28K23TxI888WJK84q8S4WfY2Sy;acw_tc=0ad5243b17392388983295533eefd405d1326b0c5ed2f25619b432ec67d319;web_session=0400698c9f6a0a56f7cb7ee69f354b7701dd59"
...
def get_context_page(playwright):
    ...
    browser_context.add_init_script(path="D:/doubao/xhs/autopublishxhs-main/stealth.min.js")
...
def test_create_simple_note(xhs_client: XhsClient):
    ...
    desc = "下面我说两点 \n 1. 第一点 \n 2. 第二点"
    images = [
        "D:/doubao/xhs/autopublishxhs-main/1735093068367.jpg",
    ]
